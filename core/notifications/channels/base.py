...
class BaseNotificationChannel(ABC):
    ...
    def filter_recipients_by_preferences(
        ...
        raise NotImplementedError(
            "Subclasses must implement filter_recipients_by_preferences() method"
        )

    @abstractmethod
    def transform_context(
        self, base_context: dict[str, Any], event: NotificationEvent
    ) -> dict[str, Any]:
        """
        ...
        """
        raise NotImplementedError(
            "Subclasses must implement transform_context() method"
        )
    ...
    def validate_recipients(self, recipients: List["User"]) -> List["User"]:
        ...
        """
        raise NotImplementedError(
            "Subclasses must implement validate_recipients() method"
        )
